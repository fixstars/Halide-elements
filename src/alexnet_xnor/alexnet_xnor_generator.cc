...
public:
    ...
    Func build()
    {
        ...
        conv1(c, x, y, n) = conv_fixed32<FB>(input, conv1_weight, conv1_bias, conv1_weight_shape, conv1_stride, conv1_pad,
        ...
        scale1(c, x, y, n) = scale_fixed32<FB>(bn1, scale1_weight, scale1_bias, bn1_top_shape, scale1_top_shape)(c, x, y, n);
        ...
        conv2(c, x, y, n) = bin_conv_fixed32<FB>(active2, conv2_weight, conv2_alpha, conv2_bias, conv2_weight_shape,
        ...
        conv3(c, x, y, n) = bin_conv_fixed32<FB>(active3, conv3_weight, conv3_alpha, conv3_bias, conv3_weight_shape,
                                     active3_top_shape, conv3_top_shape)(c, x, y, n);

        // Bn4
        Func bn4("bn4");
        std::vector<int32_t> bn4_top_shape;
        bn4(c, x, y, n) = bn_fixed32<FB>(conv3, bn4_mean, bn4_variance, conv3_top_shape, bn4_top_shape)(c, x, y, n);

        // Scale4
        Func scale4("scale4");
        std::vector<int32_t> scale4_top_shape;
        scale4(c, x, y, n) = scale_fixed32<FB>(bn4, scale4_weight, scale4_bias, bn4_top_shape, scale4_top_shape)(c, x, y, n);
        ...
        conv4(c, x, y, n) = bin_conv_fixed32<FB>(active4, conv4_weight, conv4_alpha, conv4_bias, conv4_weight_shape,
        ...
        bn5(c, x, y, n) = bn_fixed32<FB>(conv4, bn5_mean, bn5_variance, conv4_top_shape, bn5_top_shape)(c, x, y, n);

        // Scale5
        Func scale5("scale5");
        std::vector<int32_t> scale5_top_shape;
        scale5(c, x, y, n) = scale_fixed32<FB>(bn5, scale5_weight, scale5_bias, bn5_top_shape, scale5_top_shape)(c, x, y, n);
        ...
        bn6(c, x, y, n) = bn_fixed32<FB>(pool5, bn6_mean, bn6_variance, pool5_top_shape, bn6_top_shape)(c, x, y, n);

        // Scale6
        Func scale6("scale6");
        std::vector<int32_t> scale6_top_shape;
        scale6(c, x, y, n) = scale_fixed32<FB>(bn6, scale6_weight, scale6_bias, bn6_top_shape, scale6_top_shape)(c, x, y, n);
        ...
        fc6(c, x, y, n) = bin_conv_fixed32<FB>(active6, fc6_weight, fc6_alpha, fc6_bias, fc6_weight_shape, 1, 0,
        ...
        bn7(c, x, y, n) = bn_fixed32<FB>(fc6, bn7_mean, bn7_variance, fc6_top_shape, bn7_top_shape)(c, x, y, n);

        // Scale7
        Func scale7("scale7");
        std::vector<int32_t> scale7_top_shape;
        scale7(c, x, y, n) = scale_fixed32<FB>(bn7, scale7_weight, scale7_bias, bn7_top_shape, scale7_top_shape)(c, x, y, n);
        ...
        fc7(c, x, y, n) = bin_conv_fixed32<FB>(active7, fc7_weight, fc7_alpha, fc7_bias, fc7_weight_shape, 1, 0,
                                   active7_top_shape, fc7_top_shape)(c, x, y, n);

        // Bn8
        Func bn8("bn8");
        std::vector<int32_t> bn8_top_shape;
        bn8(c, x, y, n) = bn_fixed32<FB>(fc7, bn8_mean, bn8_variance, fc7_top_shape, bn8_top_shape)(c, x, y, n);

        // Scale8
        Func scale8("scale8");
        std::vector<int32_t> scale8_top_shape;
        scale8(c, x, y, n) = scale_fixed32<FB>(bn8, scale8_weight, scale8_bias, bn8_top_shape, scale8_top_shape)(c, x, y, n);

        // relu8
        Func relu8("relu8");
        std::vector<int32_t> relu8_top_shape;
        relu8(c, x, y, n) = relu4d(scale8, scale8_top_shape, relu8_top_shape)(c, x, y, n);
        ...
        fc8(c, x, y, n) = conv_fixed32<FB>(relu8, fc8_weight, fc8_bias, fc8_weight_shape, 1, 0, relu8_top_shape, fc8_top_shape)(c, x, y, n);
