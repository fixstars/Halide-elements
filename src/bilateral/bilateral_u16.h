#ifndef HALIDE_____bilateral_u16_h
#define HALIDE_____bilateral_u16_h
#include <stdint.h>
...
int bilateral_u16(struct halide_buffer_t *_src_buffer, int32_t _window_size, double _sigma_color, double _sigma_space, struct halide_buffer_t *_dst_buffer) HALIDE_FUNCTION_ATTRS;
int bilateral_u16_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *bilateral_u16_metadata() HALIDE_FUNCTION_ATTRS;

int bilateral_u16_old_buffer_t(struct buffer_t *_src, int32_t _window_size, double _sigma_color, double _sigma_space, struct buffer_t *_dst) HALIDE_FUNCTION_ATTRS;
